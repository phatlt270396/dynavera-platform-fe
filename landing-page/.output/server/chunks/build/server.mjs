...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-L2SSHCZ0.mjs')
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./index-IFAzSuvB.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-DsWSxv33.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CGuas4Mg.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CT-zTfOI.mjs'));
