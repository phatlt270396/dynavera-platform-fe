      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="space-y-6 lg:col-span-2">
          ...
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24">Location<span class="text-red-500">*</span></label>
            <select class="border border-gray-300 rounded px-3 py-2 text-sm w-40">
          ...
          <div class="flex items-start space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24 mt-2">Protocol<span class="text-red-500">*</span></label>
            <div class="flex-1">
          ...
          <!-- Authentication -->
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24">Authentication</label>
          ...
          <!-- UDP -->
          <div class="flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24">UDP</label>
            <div class="flex space-x-2">
              <button 
          ...
          <!-- Bandwidth Price -->
          <div class="flex items-start space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24 mt-2">bandwidth price</label>
            <div class="flex-1">
              <div class="flex space-x-2">
                <button 
          ...
          <!-- Special Inbound -->
          <div class="flex items-start space-x-3">
            <label class="text-sm font-medium text-gray-700 w-24 mt-2">Special inbound</label>
            <div class="flex-1">
              <div class="flex space-x-2">
                <button 
        ...
        <div class="space-y-6 lg:col-span-2">
          ...
          <div class="bg-gray-50 rounded-lg p-4 space-y-2">
            <div class="flex justify-between text-sm">
              ...
              <span class="text-gray-900">Data Center IP</span>
            </div>
            <div class="flex justify-between text-sm">
